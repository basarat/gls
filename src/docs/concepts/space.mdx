...
- Collapses. You set a value, but it renders as something else depending on the neighbours.

![margincollapse](../images/margincollapse.png)

- Reduces reuse. Margins on components disable placement for pixel perfectly.
