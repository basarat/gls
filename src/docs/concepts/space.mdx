...
The difference between pixel perfect and good enough mostly boils down to whitespace management. Here we discuss the `airspace` thought pattern developed in GLS.
