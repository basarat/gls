...
- show simple button 
- show simple label+input
- show simple three label+input

# Better Way

Realize: your external space, is your parents internal space. Any component is free to manage its internal space anyway it wants. 
...
# Components 
This is exactly what our container components `Vertical` / `Horizontal` provide (and many more features).