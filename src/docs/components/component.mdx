...
## component
There is a `gls.component` function that takes any set of these props and returns a set of props with any `ComponentProps` omitted and a `className` that you can use to power to root of your component.

We look at examples below.

## Creating a component
You can use any partial set of `ComponentProps` in your component e.g: 
...
Any props tht are not a part of `ComponentProps` are yours to handle and returned as is from `gls.component` e.g.: 
