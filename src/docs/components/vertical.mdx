...
## Alignment
By default `verticalAlign:top` and `horizontalAlign:stretch`. It help you write simple vertical layouts that start vertically at the top and fill the horizontal space completely: 
