...
> If a component is going to occupy a significant portion of user's interaction time, then it should be full width by default. 
...
> If a component is going to be a critical part of page design then it should be full height by default
