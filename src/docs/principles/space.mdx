---
name: Space principle
route: /principle-space/
---
...
The difference between pixel perfect and good enough mostly boils down to whitespace management. Here we discuss the `Space` principle developed in GLS.
...
Lets look at some examples of external-margin-free components and how they nicely compose. First a simple component e.g. an input:
